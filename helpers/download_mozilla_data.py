...
Usage:
    ...
    python helpers/download_mozilla_data.py --api --languages amharic russian
    ...
    python helpers/download_mozilla_data.py --cv-root /path/to/cv-corpus
"""
...
from config import LANGUAGES, MOZILLA_CLIPS_PER_LANGUAGE, PROJECT_ROOT, RAW_DIR, SEED
