"""
Add external Amharic clips until data/raw/amharic reaches CLIPS_PER_LANGUAGE.

Source: ALFFA Amharic via Hugging Face.

Usage:
    python populate_amharic.py
    python populate_amharic.py --target 5000
"""
...
def main():
    ...
    parser.add_argument(
        ...
        help="Target Amharic clip count. Defaults to CLIPS_PER_LANGUAGE.",
    )
    parser.add_argument(
        "--seed",
        type=int,
